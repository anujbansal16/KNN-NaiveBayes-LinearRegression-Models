...
print("Linear Regression on AdmissionDataset Various Error functions")
testFile=None
if len(sys.argv)>1:
...
print("=======================================================================================")
MSE(*predictProbAdmit("AdmissionDataset/data.csv",80,[1,2,3,4,5,6,7],8,False,testFile)[:3])
MAE(*predictProbAdmit("AdmissionDataset/data.csv",80,[1,2,3,4,5,6,7],8,False,testFile)[:3])
MPE(*predictProbAdmit("AdmissionDataset/data.csv",80,[1,2,3,4,5,6,7],8,False,testFile)[:3])
print("=======================================================================================")