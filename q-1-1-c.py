...
matrix=trainAndPredict("Iris/Iris.csv",80,7,4,"iris",2,testFile)
print("=================================")
...
print("=======================================================")
print("Scikit Learn for Iris")
print("=======================================================")
print("Accuracy and measuremenst matrix for Iris")
skLearn("Iris/Iris.csv",80,",",[4],[4],7,4,None,testFile)
print("=======================================================")