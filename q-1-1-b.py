...
matrix=trainAndPredict("RobotDataset/Robot2",80,7,1,"robot",2,testFile)
if matrix:
    print("=================================")
...
print("=======================================================")
print("Scikit Learn for Robot2")
print("=======================================================")
print("Accuracy and measurement matrix for Robot2")
skLearn("RobotDataset/Robot2",80," ",[0,1,8],[],7,1,"binary",testFile)
print("=======================================================")